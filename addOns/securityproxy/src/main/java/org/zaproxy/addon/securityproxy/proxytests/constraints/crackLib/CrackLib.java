...
import org.zaproxy.addon.securityproxy.proxytests.constraints.crackLib.Rules;
...
public class CrackLib {
  ...
  public static final boolean fascistLook(Packer p, String password, String username) throws IOException
  {
