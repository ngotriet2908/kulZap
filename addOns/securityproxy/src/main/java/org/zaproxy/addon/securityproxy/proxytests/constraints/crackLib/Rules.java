...
public class Rules {
  ...
  public static boolean suffix(String myword, String suffix)
  {
    int i = myword.length();
    int j = suffix.length();
  ...
  public static boolean matchClass(char clazz, char c)
  {
  ...
  public static boolean pMatch(String control, String s)
  {
